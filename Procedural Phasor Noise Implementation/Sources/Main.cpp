...
void init () {
	...
	glfwGetWindowSize(windowPtr, &viewportWidth, &viewportHeight);
	rasterizerPtr->setViewportResolution(viewportWidth, viewportHeight);
}
...
void update (float currentTime) {
	...
	rasterizerPtr->setTime(currentTime);
}
